...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.1deb5ubuntu1&nocache=2650998151ltr&server=1">
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/printview.css?v=5.1.1deb5ubuntu1" media="print" id="printcss">
    <title>193.206.183.37 / localhost | phpMyAdmin 5.1.1deb5ubuntu1</title>
  ...
  <script data-cfasync="false" type="text/javascript" src="js/messages.php?l=en&v=5.1.1deb5ubuntu1"></script>
  ...
  <script data-cfasync="false" type="text/javascript" src="js/dist/export_output.js?v=5.1.1deb5ubuntu1"></script>
...
CommonParams.setAll({common_query:"",opendb_url:"index.php?route=/database/structure",lang:"en",server:"1",table:"",db:"",token:"64282f2464332b7a774f783d72675529",text_dir:"ltr",show_databases_navigation_as_tree:true,pma_text_default_tab:"Browse",pma_text_left_default_tab:"Structure",pma_text_left_default_tab2:false,LimitChars:"50",pftext:"P",confirm:true,LoginCookieValidity:"1440",session_gc_maxlifetime:"1440",logged_in:true,is_https:false,rootPath:"/phpmyadmin/",arg_separator:"&",PMA_VERSION:"5.1.1deb5ubuntu1",auth_type:"cookie",user:"root"});
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=analytics&table=customer">`analytics`.`customer`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=analytics&table=sale">`analytics`.`sale`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=CSV_DB+7&table=customer">`CSV_DB 7`.`customer`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wordpressdawsec&table=wp_redirection_404">`wordpressdawsec`.`wp_redirection_404`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wordpressdawsec&table=wp_redirection_groups">`wordpressdawsec`.`wp_redirection_groups`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wordpressdawsec&table=wp_posts">`wordpressdawsec`.`wp_posts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wordpressdawsec&table=wp_postmeta">`wordpressdawsec`.`wp_postmeta`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wordpressdawsec&table=wp_plugin_papercite_url">`wordpressdawsec`.`wp_plugin_papercite_url`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wordpressdawsec&table=wp_plugin_papercite">`wordpressdawsec`.`wp_plugin_papercite`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wordpressdawsec&table=wp_options">`wordpressdawsec`.`wp_options`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="64282f2464332b7a774f783d72675529">
    ...
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="analytics" targettable="customer">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `customer`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="analytics" targettable="sale">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
